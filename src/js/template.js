...
export const renderRepositoryTemplate = (data) => {
  if (!data || data.nodes.length === 0) {
    return `<h1 class='ml-4 pl-4 mt-2'> No repository found for this user </h1>`;
  }
    ...
    const repoItem = `<li class="col-12 d-flex w-100">
        <section class="col-10 col-lg-9 d-inline-block">
            ...
            <section>
                ...
                <p class="col-9 d-inline-block mb-3 pr-4 repo-description">
...
${repo?.description ?? ""}
            ...
            <section class="repo-description">
                ${
                  repo?.languages?.nodes && repo.languages.nodes.length !== 0
                    ? `<span class="mr-4">
                <span class="repo-lang-info d-inline-block pos-rel v-align-middle" style="background-color: ${repo.languages.nodes[0].color} !important;"></span>
                <span class="v-align-middle">${repo.languages.nodes[0].name}</span>
            </span>`
                    : ""
                }
              ${
        ...
        <section class="col-2 col-lg-3 d-flex flex-column star-container">
            <div >

                <button class="btn btn-small">
                    <svg class="octicon octicon-star mr-2" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25zm0 2.445L6.615 5.5a.75.75 0 01-.564.41l-3.097.45 2.24 2.184a.75.75 0 01.216.664l-.528 3.084 2.769-1.456a.75.75 0 01.698 0l2.77 1.456-.53-3.084a.75.75 0 01.216-.664l2.24-2.183-3.096-.45a.75.75 0 01-.564-.41L8 2.694v.001z"></path></svg>
                    Star
                </button>
            </div>
        </section>
    ...
    document
      ...
      .insertAdjacentHTML("beforeend", repoItem);
  });
};
